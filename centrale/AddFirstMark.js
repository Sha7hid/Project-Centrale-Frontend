...
export default function AddFirstMark({navigation}) {
  ...
  const [success,setSuccess] = useState(false);
    const handleSubmit = () => {
      ...
      const apiUrl = `https://centrale.onrender.com/mark/first_presentation/update/studentid/${studentid}`;
  ...
  return (
    ...
    <View style={styles.container}>
        <Text style={styles.textstyles}>Add Mark For First Presentation</Text>
     ...
     <View style={styles.spacetop}></View>
     {success?<Text style={styles.text}>Successfully Added First Presentation Mark 🎊</Text>:<Text></Text>}
     <View style={styles.spacetop}></View>
