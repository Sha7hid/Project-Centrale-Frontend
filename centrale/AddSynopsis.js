...
export default function AddSynopsis({navigation}) {
    ...
    const handleSubmit = () => {
      ...
      const apiUrl = `http://192.168.1.4:8080/project/synopsis/update/teamid/${teamData.id}`;
  ...
  return (
    <View style={styles.container}>
        ...
        <Text style={styles.text}>You can also update existing synopsis url</Text>
        <View style={styles.spacetop}></View>
...
<Text style={styles.cardtext}>{projectData.synopsis}</Text>
          ...
          :<Text style={styles.cardtext}>No Synopsis</Text>  
          }
            </View>
    </View>
  );
