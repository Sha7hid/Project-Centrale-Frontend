...
export default function AddReportMark({navigation}) {
  ...
  const [success,setSuccess] = useState(false);
    const handleSubmit = () => {
      ...
      const apiUrl = `https://centrale.onrender.com/mark/report/update/studentid/${studentid}`;
  ...
  return (
    ...
    <View style={styles.container}>
        <Text style={styles.textstyles}>Add Mark For Report</Text>
     ...
     <View style={styles.spacetop}></View>
     {success?<Text style={styles.text}>Successfully Added Report Mark 🎊</Text>:<Text></Text>}
     <View style={styles.spacetop}></View>
