...
export default function AddReport({navigation}) {
    ...
    const handleSubmit = () => {
      ...
      const apiUrl = `https://centrale.onrender.com/project/report/update/teamid/${teamData.id}`;
  ...
  return (
    <View style={styles.container}>
        <Text style={styles.textstyles}>Add Url Of Report</Text>
        <View style={styles.spacetop}></View>
        <Text style={styles.text}>You can also update existing Report url</Text>
        <View style={styles.spacetop}></View>
     ...
     <View style={styles.spacetop}></View>
     {success?<Text style={styles.text}>Successfully Added Report 🎊</Text>:<Text></Text>}
     <View style={styles.spacetop}></View>
...
<Text style={styles.cardtext}>{projectData.report}</Text>
              </Pressable>
          :<Text style={styles.cardtext}>No Report</Text>  
          }
            </View>
    </View>
  );
