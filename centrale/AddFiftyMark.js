...
export default function AddFiftyMark({navigation}) {
  ...
  const [success,setSuccess] = useState(false);
    const handleSubmit = () => {
      ...
      const apiUrl = `https://centrale.onrender.com/mark/fifty_percent/update/studentid/${studentid}`;
  ...
  return (
    ...
    <View style={styles.container}>
        <Text style={styles.textstyles}>Add Mark For 50% Coding</Text>
     ...
     <View style={styles.spacetop}></View>
     {success?<Text style={styles.text}>Successfully Added 50% Coding Mark 🎊</Text>:<Text></Text>}
     <View style={styles.spacetop}></View>
