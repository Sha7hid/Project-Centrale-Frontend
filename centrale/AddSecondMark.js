...
export default function AddSecondMark({navigation}) {
  ...
  const onRefresh = React.useCallback(async () => {
    ...
    const handleSubmit = () => {
      ...
      const apiUrl = `https://centrale.onrender.com/mark/second_presentation/update/studentid/${studentid}`;
    const parsedmark = parseInt(mark)
      ...
      fetch(apiUrl, {
        ...
        .then(Alert.alert('🎊','Successfully Added Second Presentation Mark'))
        .catch(error => {
