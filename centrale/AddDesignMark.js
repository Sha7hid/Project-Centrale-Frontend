...
export default function AddDesignMark({navigation}) {
  ...
  const [success,setSuccess] = useState(false);
    const handleSubmit = () => {
      ...
      const apiUrl = `http://192.168.1.5:8080/mark/design/update/studentid/${studentid}`;
...
console.log(TeamData)
  ...
  return (
    ...
    <View style={styles.container}>
        <Text style={styles.textstyles}>Add Mark For Design</Text>
