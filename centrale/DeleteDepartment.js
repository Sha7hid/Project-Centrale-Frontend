...
export default function DeleteDepartment({navigation}) {
  ...
  const handleDelete = async () => {
    const apiUrl = `https://centrale.onrender.com/departments/${userId}`;
    ...
    fetch(apiUrl, {
      ...
      .then(Alert.alert('🎊','Successfully Deleted Department'))
      .catch(error => {
...
console.log(userId)
  return (
    ...
    <View style={styles.container}>
        <Text style={styles.textstyles}>Select the department to delete</Text>
     ...
     <Picker
      ...
      >
        ...
        {studentData?.map((student) => (
          <Picker.Item key={student.departmentId} label={student.departmentName} value={student.departmentId} />
        ))}
      </Picker>
     <View style={styles.spacetop}></View>
